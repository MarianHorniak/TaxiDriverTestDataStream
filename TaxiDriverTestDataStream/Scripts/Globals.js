var Globals =
{
    ...
    constants: {
        ...
        GoogleMapsApiKey: "AIzaSyDH8zs8aU1FN8y_zYtoYoHXCnUDwkyq2RU"
    },
    ...
    GetPhoneSetting: function () {
        ...
        Service.getListItems("view_PhoneSettings", function (listitems) {
            ...
            sVal = Globals.GetSetItem("GoogleMapsApiKey");
            if (sVal) Globals.constants.GoogleMapsApiKey = sVal;
    ...
    LoadGoogleMapsScript: function () {
        if (!Globals.constants.GoogleMapsApiKey)
            return;

        var script = document.createElement('script');
        script.type = 'text/javascript';
        script.src = 'https://maps.google.com/maps/api/js?callback=MapUtility.apiOK' +
            '&key=' + Globals.constants.GoogleMapsApiKey;
